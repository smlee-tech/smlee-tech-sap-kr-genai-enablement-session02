...
def get_embedding(input, model="d4971d165d84d536") -> str:
...
def ask_llm(query: str, retrieval_augmented_generation = True, metric='COSINE_SIMILARITY', k = 5) -> str:
    ...
    temperature = 0.1 #if language == 'kr' else 0.3
    
    llm = ChatOpenAI(deployment_id="d36b7697328746e0", temperature=temperature)
